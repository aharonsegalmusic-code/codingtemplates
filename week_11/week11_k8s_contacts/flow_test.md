...
IMAGE_NAME="aharonsegal/fastapi_test_make"
IMAGE_TAG="v1"          # change version as needed
FULL_IMAGE="aharonsegal/fastapi_test_make:v1"
"aharonsegal/fastapi_test_make:v1"
```
...
docker build -t "aharonsegal/fastapi_test_make:v1" -t "aharonsegal/fastapi_test_make:latest" .
```
...
docker build -t aharonsegal/fastapi:v1 -t aharonsegal/fastapi_test_make:v1 .
```
...
```bash
docker run --rm -p 8000:8000 ""aharonsegal/fastapi_test_make:v1""
...
```bash
docker run -d -p 8000:8000 --name fastapi_test ""aharonsegal/fastapi_test_make:v1""
```
...
docker push ""aharonsegal/fastapi_test_make:v1""
docker push "aharonsegal/fastapi_test_make:latest"
```
...
```bash
docker pull ""aharonsegal/fastapi_test_make:v1""
docker run --rm -p 8000:8000 ""aharonsegal/fastapi_test_make:v1""
```
...
1. Rebuild & push new image (e.g., `v2`):
   ...
   ```bash
   cd "$PROJECT_ROOT/app"
   docker build -t "aharonsegal/fastapi_test_make:v2" -t "aharonsegal/fastapi_test_make:latest" .
   docker push "aharonsegal/fastapi_test_make:v2"
   docker push "aharonsegal/fastapi_test_make:latest"
   ```
