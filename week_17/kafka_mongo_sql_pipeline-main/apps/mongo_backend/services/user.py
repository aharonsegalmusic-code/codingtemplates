...
class UserService:
    ...
    """
    this function gets a pydantic objet of a user 
    ...
    ---
    we now need to parse the pydatic obets into formated stings to be ready to be inserted to the db

    ======

    - we start with formating the email
    - then we check for duplicated 
